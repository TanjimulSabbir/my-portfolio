...
import Logo from "../../assets/Photos/Logo/apple-touch-icon.png";
        ...
        <div className="navbar flex item-center justify-between text-white z-50 rubik">
          <div className="md:hidden">
            ...
            >
              <p
                className={`${
                  open && "transition duration-700 transform rotate-90"
                }`}
              >
            ...
            <ul
              ...
              className={`${
                open || "hidden"
              } fixed inset-0 px-6 py-24 shadow w-screen h-screen space-y-8 bg-[#35a55e] uppercase text-black`}
            >
              {Menu}
              <div className="absolute top-0 right-1">
                <label
                  tabIndex={0}
                  onClick={() => setOpen(!open)}
                  className="btn btn-outline text-4xl border-none hover:bg-transparent text-black md:hidden mr-4"
                >
                  <p
                    className={`${
                      open && "transition duration-700 transform rotate-90"
