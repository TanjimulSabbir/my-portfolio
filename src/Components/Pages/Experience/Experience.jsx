...
const Experience = () => {
    return (
        <div id='experience' className='mid-lg:w-3/5 py-24 mx-auto'>
            ...
            <div className='mt-14 flex space-x-20 justify-center'>
                <div className=''>
                    <div className="text-custom-highLightTextColor">
                        <h1>Inventive</h1>
                    </div>
                </div>
                <div>
                    <div className="border-l border-custom-highLightTextColor border-spacing-1 pl-4">
