...
function Introduction() {
    ...
    return (
        <div className="UniversalPadding h-screen w-full text-white">
            <div className="lg:w-1/2 h-full flex-1 mx-auto flex pt-24 md:pt-0 md:items-center justify-center  z-10">
                <div className="mid-lg:-mt-28">
                    ...
                    <p className="text-sm md:text-base mt-7 lato pl-0 text-white">{text}</p>

                    <button onClick={() => window.location.href = "#contact"} className="mt-10 uppercase border-2 rounded border-white px-14 py-4 inline-block transition-all duration-700 hover:bg-white hover:text-gray-900">
                        Get in touch
                    </button>
