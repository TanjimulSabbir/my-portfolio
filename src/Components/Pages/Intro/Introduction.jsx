            ...
            <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-80">
                <div className="text-center">
                    ...
                    <p className='mt-20 lg:w-2/3 mx-auto text-justify'>
                        I'm a skilled <span className="text-custom-highLightTextColor">front-end developer </span> with a passion for building dynamic and interactive websites. My expertise lies in harnessing the power of Javascript, React.js, Tailwind CSS, Redux, and other cutting-edge technologies to craft seamless web experiences that engage and captivate users.
                    </p>
