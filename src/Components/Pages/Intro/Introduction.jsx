...
function Introduction() {
    ...
    return (
        <div className="h-screen w-full bg-black bg-opacity-90 text-[#38b365]">
            <div className="IntroMargin w-1/2 h-full mx-auto flex items-center justify-center z-10">
                <div className="">
                    <h4 className='mb-2 lato'>
                        Hi, my name is
                    </h4>
                    <h2 className='Exo2 text-[#35a55e] text-4xl lg:text-[55px] xl:text-6xl font-extrabold uppercase whitespace-nowrap'>
                        Tanjimul Islam Sabbir
                    </h2>

                    <h1 className="mt-2 robotoSlab">Front-end Developer | Reactjs Developer</h1>
                    {/* <Typewriter text={text} /> */}
                    <p className="mt-7 lato">{text}</p>
